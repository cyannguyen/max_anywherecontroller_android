...
- (void)flushWKWebview:(CDVInvokedUrlCommand*)command;
{
    WKWebView* wkWebView = (WKWebView*)_engineWebView;
    wkWebView.configuration.processPool = [[CDVWKProcessPoolFactory sharedFactory] sharedProcessPool];
    [self.commandDelegate runInBackground:^{
        NSMutableDictionary *forceCookie = [NSMutableDictionary dictionary];
        [forceCookie setObject:@"forceWebView" forKey:NSHTTPCookieName];
        [forceCookie setObject:@"forceWebView" forKey:NSHTTPCookieValue];
        [forceCookie setObject:@"forceWebView" forKey:NSHTTPCookieDomain];
        [forceCookie setObject:@"forceWebView" forKey:NSHTTPCookieOriginURL];
        [forceCookie setObject:@"/" forKey:NSHTTPCookiePath];
        [forceCookie setObject:@"0" forKey:NSHTTPCookieVersion];
        
        NSHTTPCookie *cookie = [NSHTTPCookie cookieWithProperties:forceCookie];
