...
- (void) isAvailable:(CDVInvokedUrlCommand*)command {
  ...
  [self.commandDelegate runInBackground:^{
    ...
    LAContext *laContext = [[LAContext alloc] init];
      ...
      // Hide "Enter Password" button
      laContext.localizedFallbackTitle = @"Use PIN";
...
-(void)verify:(CDVInvokedUrlCommand*)command{
    // Hide "Enter Password" button
    self.laContext.localizedFallbackTitle = @"Use PIN";
    self.laContext.localizedCancelTitle   = @"Cancel";
    self.laContext.maxBiometryFailures = @3;
    ...
    BOOL hasLoginKey = [[NSUserDefaults standardUserDefaults] boolForKey:self.TAG];
    if(hasLoginKey){
        BOOL touchIDAvailable = [self.laContext canEvaluatePolicy:LAPolicyDeviceOwnerAuthentication error:nil];
        // Hide "Enter Password" button
        self.laContext.localizedFallbackTitle = @"Use PIN";
        self.laContext.localizedCancelTitle   = @"Cancel";
        self.laContext.maxBiometryFailures = @3;
