...
enum {
    ...
    KFFileExists = 6625,
    // Failed the Processes Check with XCon
    KFProcessesXCon = 11014,
    // Failed the Processes Check with other XCon
    KFProcessesOtherXCon = 42933
...
#define XCON        @"MobileXCon"
#define OTHERXCON   @"XCon"
...
- (int)processesCheck {
    @try {
        ...
        for (NSDictionary * dict in processes) {
            ...
            } else if ([process isEqualToString:XCON]) {
                // Return Jailbroken
                return KFProcessesXCon;
            } else if ([process isEqualToString:OTHERXCON]) {
                // Return Jailbroken
                return KFProcessesOtherXCon;
            }
