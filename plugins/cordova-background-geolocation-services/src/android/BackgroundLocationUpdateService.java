...
public class BackgroundLocationUpdateService
    ...
    private Integer createCounter  = 0;
    ...
    public final static String NOTIFICATION_CHANNEL = "com.flybuy.cordova.location.background_location_service";
    ...
    public void onCreate() {
        ...
        createCounter ++;
        Log.i(TAG, "BackgroundLocationUpdateService :: OnCreate :: " + createCounter);
        System.out.println("BackgroundLocationUpdateService :: OnCreate :: " + createCounter);
        ...
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notificationManager.createNotificationChannel(new NotificationChannel(NOTIFICATION_CHANNEL, "Background location Service", NotificationManager.IMPORTANCE_DEFAULT));
        }
        ...
        /*} catch (Exception ex) {
        	ex.printStackTrace();
        	System.out.println("BackgroundLocationUpdateService :: OnCreate - Error :: " + createCounter);
        	Log.i(TAG, "BackgroundLocationUpdateService :: OnCreate -Error :: " + createCounter);
        }*/
        // Location criteria
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            Notification.Builder builder = new Notification.Builder(this, android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.O ? NOTIFICATION_CHANNEL : "");
